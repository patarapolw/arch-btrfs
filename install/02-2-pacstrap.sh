...
pacstrap /mnt base base-devel "${kernel}" "${kernel}-firmware" "${microcode}" grub grub-btrfs snapper efibootmgr sudo networkmanager apparmor nano firewalld ntfs-3g reflector snap-pac snap-sync noto-fonts noto-fonts-cjk noto-fonts-emoji noto-fonts-extra git zsh zsh-completions bash-completions
